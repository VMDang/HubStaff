...
public class HRMUnitOfficerReportRow {
    private String name;
    ...
    public HRMUnitOfficerReportRow(String name, String officer_id, String unit_id, String total_day_work, float total_overtime, float countLateEarly, int status) {
        this.name = name;
