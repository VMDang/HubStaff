...
public class TimekeepingWorkerTableRow {
    private Date date;
	...
	public TimekeepingWorkerTableRow(Date date, Time time_in, Time time_out, float hour_work, float overtime,
	...
	public TimekeepingWorkerTableRow(Date date, String status) {
		this.date = date;
		this.time_in = null;
		this.time_out = null;
		this.hour_work = 0f;
