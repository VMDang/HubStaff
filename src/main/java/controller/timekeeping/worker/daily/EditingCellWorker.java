...
public class EditingCellWorker extends TableCell<LogTimekeepingWorker, Time> {
    private TextField textField;
    private BiConsumer<LogTimekeepingWorker, Time> updateCallback;

    public EditingCellWorker(BiConsumer<LogTimekeepingWorker, Time> updateCallback) {
    ...
    public void commitEdit(Time newValue) {
        ...
        LogTimekeepingWorker currentWorker = getTableView().getItems().get(getIndex());
        if (updateCallback != null) {
            updateCallback.accept(currentWorker, newValue);
        }
    }
